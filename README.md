...
## 🚀 Funcionalidades
- **Dados em Tempo Real:** Exibe temperatura (Celsius) e condições climáticas via API.
- **Internacionalização:** Sistema de troca de idiomas integrado para mudar a linguagem do app instantaneamente.
- **Busca de Cidades:** Encontre rapidamente os detalhes climáticos de qualquer cidade brasileira.
- **Interface Intuitiva:** Layout minimalista projetado para uma excelente experiência mobile.
